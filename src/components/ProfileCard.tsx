...
export default function ProfileCard() {
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mx-auto lg:mx-0">
      <div className="premium-card relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-4 sm:p-5 shadow-[0_30px_90px_-35px_rgba(0,0,0,0.45)] transition-transform duration-500 hover:-translate-y-1.5">
        ...
        <div className="relative z-10 flex flex-col items-center gap-4 py-6 sm:py-8">
          <div className="relative flex items-center justify-center float-y">
            ...
            <div className="relative overflow-hidden rounded-full border border-white/8 w-[180px] h-[180px] sm:w-[220px] sm:h-[220px] md:w-[260px] md:h-[260px] lg:w-[300px] lg:h-[300px] shadow-[0_10px_30px_rgba(80,60,120,0.18)] bg-bg-panel-2">
              <Image
                src={profileImage}
